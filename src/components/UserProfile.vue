<template>
  ...
  <div :class="{ 'user-operation' : !smMode }" v-else>
    <a-button type="primary" @click="createDesign" v-if="!smMode" style="border-radius: 20px">
      创建设计
    </a-button>
    <a-button type="primary" class="user-profile-component" v-if="!smMode" style="border-radius: 20px">
